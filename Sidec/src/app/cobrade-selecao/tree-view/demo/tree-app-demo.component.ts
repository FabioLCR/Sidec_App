...
import { NodeMenuItemAction } from './menu.events';
...
export class TreeAppDemo implements OnInit {
  ...
  private static logEvent2(e: MenuItemSelectedEvent, message: string): void {
    console.log(e);
    alertify.message(`${message}: ${e.node.value}`);
  }
  ...
  public onNodeRemoved(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Removed');
  }

  public onNodeMoved(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Moved');
  }

  public onNodeRenamed(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Renamed');
  }

  public onNodeCreated(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Created');
  }
  ...
  public onNodeSelected(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Selected');
  }

  public onNodeUnselected(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Unselected');
  }

  public onMenuItemSelected(e: MenuItemSelectedEvent) {
    TreeAppDemo.logEvent2(e, `You selected ${e.selectedItem} menu item`);
  }

  public onNodeExpanded(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Expanded');
  }

  public onNodeCollapsed(e: NodeEvent): void {
    TreeAppDemo.logEvent(e, 'Collapsed');
  }
